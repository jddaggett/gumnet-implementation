...
def main(DEBUG=False):
    ...
    # Data is loaded and preprocessed in load_GroEL_ES function
    train_x, train_y, valid_x, valid_y, test_x, test_y, observed_mask, missing_mask, ground_truth = load_GroEL_ES()
